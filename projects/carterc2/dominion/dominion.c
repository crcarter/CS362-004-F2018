...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card ) 
    ...
    case smithy:
	  result = cardEffectSmithy(state, currentPlayer, handPos);
      return 0;
    ...
    case cutpurse:
      ...
      result = cardEffectCutpurse(state, currentPlayer, handPos);			
    ...
    case salvager:
      result = cardEffectSalvager(state, currentPlayer, handPos, choice1);
      return result;
...
// Refactor of Salvager
int cardEffectSalvager(struct gameState *state, int currentPlayer, int handPos, int cardToTrash)
{
